discord = {
	...
	trigger = "https://discord.com/api/webhooks/XXXXXXX", --Webhook de flodtrigger e suspeitos de tenta da ataque ddos interno | Trigger logs
	faketrigger = "https://discord.com/api/webhooks/XXXXXXX", --Webhook de FakeTrigger e suspeitos de tenta fazer faketrigger | Fake Trigger logs
	timeout = "https://discord.com/api/webhooks/XXXXXXX", --Webhook de quando um player esta com ping muinto altoo msm pode levar ate quit configure a baixo
	recursosAutorizados = "https://discord.com/api/webhooks/XXXXXXX", --Webhook de quando um sistema tenta executar um elementdata sem permissao 
	flyvehicle = "https://discord.com/api/webhooks/XXXXXXX", --  Log de ban de fly Vehicle | Fly Vehicle log
	prints = "https://discord.com/api/webhooks/XXXXXXX", -- log de fotos do servidor gerados por possiveis cheats , lembresse de ativar o Imgur
	config = {
		color = "10181046", -- Cor da embed (se ativado) Embed color (if enabled)
		avatar = "https://cdn.discordapp.com/icons/1036826442719309864/5b7c8efd4d64ebdb757fc38572373742.webp", -- Foto do bot | Bot pic
		...
		resolutionX = 1024, -- Resolução X 
		resolutionY = 768, -- Resolução Y
		quality = 18, -- Qualidade da imagem, não deixe muito alto 10~30 | Image quality
	},
}